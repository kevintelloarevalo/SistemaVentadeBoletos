...
$pdf->SetTextColor(0, 0, 0); // Negro LETRAS
$pdf->SetXY(165, 45); // Ajustar la posición XY para el contenido
$pdf->Cell(0, 10, 'Nº Orden:'. $valorVenta, 0, 1, 'A');
...
$pdf->Cell(110, 8, 'GENERAL', 1, 0, 'L', true); // Celda con color de fondo gris
...
$pdf->SetXY(10, 138); // Ajustar la posición XY para el contenido
...
$pdf->Output('COD' . $valorVenta . '-COD' . $valorVenta2 . '-' . $nombreCliente . '.pdf', 'D'); //Descargar XD
